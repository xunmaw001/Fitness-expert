  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='yonghu'"  label='腰围(cm)' prop="yonghuYaowei">
               <el-input v-model="ruleForm.yonghuYaowei"  placeholder='腰围(cm)' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='yonghu'"  label='身高(m)' prop="yonghuShengao">
               <el-input v-model="ruleForm.yonghuShengao"  placeholder='身高(m)' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='yonghu'"  label='体重(kg)' prop="yonghuTizhong">
               <el-input v-model="ruleForm.yonghuTizhong"  placeholder='体重(kg)' clearable></el-input>
           </el-form-item>
         </el-col>
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.yonghuYaowei)&& 'yonghu'==this.flag){
                             this.$message.error('腰围(cm)不能为空');
                             return
                         }

                         if((!this.ruleForm.yonghuShengao)&& 'yonghu'==this.flag){
                             this.$message.error('身高(m)不能为空');
                             return
                         }

                         if((!this.ruleForm.yonghuTizhong)&& 'yonghu'==this.flag){
                             this.$message.error('体重(kg)不能为空');
                             return
                         }
