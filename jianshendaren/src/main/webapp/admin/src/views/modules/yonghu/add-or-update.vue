               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="腰围(cm)" prop="yonghuYaowei">
                       <el-input v-model="ruleForm.yonghuYaowei"
                                 placeholder="腰围(cm)" clearable  :readonly="ro.yonghuYaowei"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="身高(m)" prop="yonghuShengao">
                       <el-input v-model="ruleForm.yonghuShengao"
                                 placeholder="身高(m)" clearable  :readonly="ro.yonghuShengao"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="体重(kg)" prop="yonghuTizhong">
                       <el-input v-model="ruleForm.yonghuTizhong"
                                 placeholder="体重(kg)" clearable  :readonly="ro.yonghuTizhong"></el-input>
                   </el-form-item>
                   <div v-else>
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   yonghuShengao: [
                              { required: true, message: '身高(m)不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]{0,6}(\.[0-9]{1,2})?$/,
                                  message: '只允许输入整数6位,小数2位的数字',
                                  trigger: 'blur'
                              }
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='yonghuYaowei'){
                          this.ruleForm.yonghuYaowei = obj[o];
                          this.ro.yonghuYaowei = true;
                          continue;
                      }
                      if(o=='yonghuShengao'){
                          this.ruleForm.yonghuShengao = obj[o];
                          this.ro.yonghuShengao = true;
                          continue;
                      }
                      if(o=='yonghuTizhong'){
                          this.ruleForm.yonghuTizhong = obj[o];
                          this.ro.yonghuTizhong = true;
                          continue;
                      }
                      if(o=='yonghuDelete'){
