...
<template>
	<view class="content">
		 <view
			 ...
			 <view class="title"
				   :style='{"width":"160rpx","fontSize":"28rpx","color":"rgba(0, 102, 51, 1)","textAlign":"left"}'>学号
			 </view>
			 <input style="padding: 0 30upx"
					...
					v-model="ruleForm.username" placeholder="学号"></input>
		 </view>
		 <view
				 :style='{"boxShadow":"0 0 2rpx #006633","backgroundColor":"rgba(247, 247, 247, 1)","borderColor":"rgba(0, 102, 51, 1)","margin":"0 0 0px 0","borderWidth":"0 0 0 0px","borderStyle":"solid","height":"88rpx"}'
				 v-if="tableName=='yonghu'" class="cu-form-group">
		 ...
		 <view
			...
			<view
				...
				<view class="title"
					  :style='{"width":"160rpx","fontSize":"28rpx","color":"rgba(0, 102, 51, 1)","textAlign":"left"}'>照片
				</view>
				<image
			...
			<view
					...
					v-if="tableName=='yonghu'" class="cu-form-group">
				<view class="title"
					  :style='{"width":"160rpx","fontSize":"28rpx","color":"rgba(0, 102, 51, 1)","textAlign":"left"}'>腰围(cm)
				</view>
				<input style="padding: 0 30upx"
					   :style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 0)","borderColor":"rgba(0, 102, 51, 1)","borderRadius":"0px","color":"rgba(0, 102, 51, 1)","textAlign":"left","borderWidth":"0 0 6rpx","fontSize":"24rpx","borderStyle":"solid","height":"68rpx"}'
					   v-model="ruleForm.yonghuYaowei" type="number" placeholder="腰围(cm)"></input>
			</view>
			<view
					:style='{"boxShadow":"0 0 2rpx #006633","backgroundColor":"rgba(247, 247, 247, 1)","borderColor":"rgba(0, 102, 51, 1)","margin":"0 0 0px 0","borderWidth":"0 0 0 0px","borderStyle":"solid","height":"88rpx"}'
					v-if="tableName=='yonghu'" class="cu-form-group">
				<view class="title"
					  :style='{"width":"160rpx","fontSize":"28rpx","color":"rgba(0, 102, 51, 1)","textAlign":"left"}'>身高(m)
				</view>
				<input style="padding: 0 30upx"
					   :style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 0)","borderColor":"rgba(0, 102, 51, 1)","borderRadius":"0px","color":"rgba(0, 102, 51, 1)","textAlign":"left","borderWidth":"0 0 6rpx","fontSize":"24rpx","borderStyle":"solid","height":"68rpx"}'
					   v-model="ruleForm.yonghuShengao" type="number" placeholder="身高(m)"></input>
			</view>
			<view
					:style='{"boxShadow":"0 0 2rpx #006633","backgroundColor":"rgba(247, 247, 247, 1)","borderColor":"rgba(0, 102, 51, 1)","margin":"0 0 0px 0","borderWidth":"0 0 0 0px","borderStyle":"solid","height":"88rpx"}'
					v-if="tableName=='yonghu'" class="cu-form-group">
				<view class="title"
					  :style='{"width":"160rpx","fontSize":"28rpx","color":"rgba(0, 102, 51, 1)","textAlign":"left"}'>体重(kg)
				</view>
				<input style="padding: 0 30upx"
					   :style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 0)","borderColor":"rgba(0, 102, 51, 1)","borderRadius":"0px","color":"rgba(0, 102, 51, 1)","textAlign":"left","borderWidth":"0 0 6rpx","fontSize":"24rpx","borderStyle":"solid","height":"68rpx"}'
					   v-model="ruleForm.yonghuTizhong" type="number" placeholder="体重(kg)"></input>
			</view>
	...
	export default {
		...
		methods: {
			...
			async update() {
					...
					if (`yonghu` == this.tableName && this.ruleForm.yonghuYaowei && (!this.$validate.isNumber(this
                                    .ruleForm.yonghuYaowei))) {
                        this.$utils.msg(`腰围(cm)应输入数字`);
                        return
                    }
					if (`yonghu` == this.tableName && this.ruleForm.yonghuShengao && (!this.$validate.isNumber(this
                                    .ruleForm.yonghuShengao))) {
                        this.$utils.msg(`身高(m)应输入数字`);
                        return
                    }
					if (`yonghu` == this.tableName && this.ruleForm.yonghuTizhong && (!this.$validate.isNumber(this
                                    .ruleForm.yonghuTizhong))) {
