		...
		<form class="app-update-pv">
            <view
                ...
                <input   readonly="readonly"
                         ...
                         :disabled="ro.username" type="text" v-model="ruleForm.username" placeholder="学号"></input>
            </view>
            <view
                    :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"88rpx"}'
                    class="cu-form-group">
            ...
            <view
                ...
                <view
                    ...
                    <view class="right-input" style="padding:0;textAlign:left">
                        ...
                        class="cu-form-group">
                    <view :style='{"width":"160rpx","fontSize":"28rpx","color":"rgba(0, 102, 51, 1)","textAlign":"left"}'
                          class="title">腰围(cm)</view>
                    <input   readonly="readonly"
                             :style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 0)","borderColor":"rgba(0, 102, 51, 1)","borderRadius":"0px","color":"rgba(0, 102, 51, 1)","textAlign":"left","borderWidth":"0 0 6rpx","fontSize":"28rpx","borderStyle":"solid","height":"68rpx"}'
                             :disabled="ro.yonghuYaowei" type="number" v-model="ruleForm.yonghuYaowei" placeholder="腰围(cm)"></input>
                </view>
                <view
                        :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"88rpx"}'
                        class="cu-form-group">
                    <view :style='{"width":"160rpx","fontSize":"28rpx","color":"rgba(0, 102, 51, 1)","textAlign":"left"}'
                          class="title">身高(m)</view>
                    <input   readonly="readonly"
                             :style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 0)","borderColor":"rgba(0, 102, 51, 1)","borderRadius":"0px","color":"rgba(0, 102, 51, 1)","textAlign":"left","borderWidth":"0 0 6rpx","fontSize":"28rpx","borderStyle":"solid","height":"68rpx"}'
                             :disabled="ro.yonghuShengao" type="number" v-model="ruleForm.yonghuShengao" placeholder="身高(m)"></input>
                </view>
                <view
                        :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"88rpx"}'
                        class="cu-form-group">
                    <view :style='{"width":"160rpx","fontSize":"28rpx","color":"rgba(0, 102, 51, 1)","textAlign":"left"}'
                          class="title">体重(kg)</view>
                    <input   readonly="readonly"
                             :style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 0)","borderColor":"rgba(0, 102, 51, 1)","borderRadius":"0px","color":"rgba(0, 102, 51, 1)","textAlign":"left","borderWidth":"0 0 6rpx","fontSize":"28rpx","borderStyle":"solid","height":"68rpx"}'
                             :disabled="ro.yonghuTizhong" type="number" v-model="ruleForm.yonghuTizhong" placeholder="体重(kg)"></input>
                </view>
	...
	export default {
		...
		methods: {
			...
			async onSubmitTap() {
				...
				if ((!this.ruleForm.yonghuYaowei) && (!this.$validate.isNumber(this.ruleForm.yonghuYaowei)) && this.ruleForm.yonghuYaowei >0) {
                    this.$utils.msg(`腰围(cm)不能为空，不能小于0 格式为数字或小数`);
                    return
                }
				if ((!this.ruleForm.yonghuShengao) && (!this.$validate.isNumber(this.ruleForm.yonghuShengao)) && this.ruleForm.yonghuShengao >0) {
                    this.$utils.msg(`身高(m)不能为空，不能小于0 格式为数字或小数`);
                    return
                }
				if ((!this.ruleForm.yonghuTizhong) && (!this.$validate.isNumber(this.ruleForm.yonghuTizhong)) && this.ruleForm.yonghuTizhong >0) {
                    this.$utils.msg(`体重(kg)不能为空，不能小于0 格式为数字或小数`);
                    return
                }
				if (this.ruleForm.id) {
